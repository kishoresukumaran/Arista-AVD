...
| --------- | --------------- | ------------ | --------- |
| mlag3 | Vlan4094 | 10.255.252.9 | Port-Channel47 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet7 | host4_Ethernet1 | *access | *30 | *- | *- | 7 |
| Ethernet47 | MLAG_PEER_LEAF6_Ethernet47 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 47 |
| Ethernet48 | MLAG_PEER_LEAF6_Ethernet48 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 47 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1_Ethernet7 | routed | - | 192.168.103.33/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2_Ethernet7 | routed | - | 192.168.103.35/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet7 | routed | - | 192.168.103.37/31 | default | 9214 | False | - | - |
| Ethernet6 | P2P_LINK_TO_SPINE4_Ethernet7 | routed | - | 192.168.103.39/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel7 | host4_PortChannel Host4 | switched | access | 30 | - | - | - | - | 7 | - |
| Port-Channel47 | MLAG_PEER_LEAF6_Po47 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| 192.168.103.36 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.103.38 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.251.9 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | vrfA | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 30 | 192.168.101.5:10030 | 10030:10030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| vrfA | 192.168.101.5:10 | connected |
...
router bgp 65104
   ...
   neighbor 10.255.251.9 description LEAF6
   ...
   neighbor 192.168.103.32 description SPINE1_Ethernet7
   neighbor 192.168.103.34 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.34 remote-as 65001
   neighbor 192.168.103.34 description SPINE2_Ethernet7
   neighbor 192.168.103.36 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.36 remote-as 65001
   neighbor 192.168.103.36 description SPINE3_Ethernet7
   neighbor 192.168.103.38 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.38 remote-as 65001
   neighbor 192.168.103.38 description SPINE4_Ethernet7
