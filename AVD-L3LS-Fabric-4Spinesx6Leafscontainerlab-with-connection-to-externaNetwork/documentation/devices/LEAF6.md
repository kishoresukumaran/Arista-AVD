...
| --------- | --------------- | ------------ | --------- |
| mlag3 | Vlan4094 | 10.255.252.8 | Port-Channel47 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet7 | host4_Ethernet2 | *access | *30 | *- | *- | 7 |
| Ethernet47 | MLAG_PEER_LEAF5_Ethernet47 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 47 |
| Ethernet48 | MLAG_PEER_LEAF5_Ethernet48 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 47 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1_Ethernet8 | routed | - | 192.168.103.41/31 | default | 9214 | False | - | - |
...
interface Ethernet48
   description MLAG_PEER_LEAF5_Ethernet48
   no shutdown
   channel-group 47 mode active
```
...
| Port-Channel47 | MLAG_PEER_LEAF5_Po47 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel47
   description MLAG_PEER_LEAF5_Po47
   no shutdown
   switchport
...
| 192.168.103.40 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 192.168.103.42 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 30 | 192.168.101.6:10030 | 10030:10030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| vrfA | 192.168.101.6:10 | connected |
...
router bgp 65104
   ...
   neighbor 10.255.251.8 description LEAF5
   ...
   neighbor 192.168.103.40 remote-as 65001
   neighbor 192.168.103.40 description SPINE1_Ethernet8
   neighbor 192.168.103.42 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.42 remote-as 65001
   neighbor 192.168.103.42 description SPINE2_Ethernet8
   neighbor 192.168.103.44 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.44 remote-as 65001
   neighbor 192.168.103.44 description SPINE3_Ethernet8
   neighbor 192.168.103.46 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.103.46 remote-as 65001
   neighbor 192.168.103.46 description SPINE4_Ethernet8
